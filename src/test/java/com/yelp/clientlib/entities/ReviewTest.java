...
public class ReviewTest extends EntityTest {
    ...
    public void testDeserializeFromJson() throws IOException {
        ...
        Assert.assertEquals(new Double(reviewNode.path("rating").asDouble()), review.rating().rating());
        Assert.assertEquals(reviewNode.path("rating_image_large_url").textValue(), review.rating().imgUrlLarge());
        Assert.assertEquals(reviewNode.path("rating_image_small_url").textValue(), review.rating().imgUrlSmall());
        Assert.assertEquals(reviewNode.path("rating_image_url").textValue(), review.rating().imgUrl());
