...
public class GiftCertificateTest {
    ...
    public void testSerializable() throws IOException, ClassNotFoundException {
        ...
        byte[] bytes = SerializationTestUtil.serialize(giftCertificate);
        Assert.assertEquals(giftCertificate, SerializationTestUtil.deserialize(bytes, GiftCertificate.class));
    }
